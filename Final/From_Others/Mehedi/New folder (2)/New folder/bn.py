...
def main():
    ...
    # Recover plaintext (using ECB as example)
    decryptedBlocks = ECB_dec(ecb, key)

    recoveredData = []
    for block in decryptedBlocks:
        recoveredData.extend(block)

    print("\nRecovered plaintext:", asciiToString(recoveredData))
